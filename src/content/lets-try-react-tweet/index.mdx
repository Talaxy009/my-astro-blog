...
date: '2023-05-07T22:35:12.990+08:00'
...
[$card](https://github.com/vercel/react-tweet/)
...
[$card](https://github.com/vercel/react-tweet/issues/45)
...
同样因为众所周知的原因 Vercel 在内地也是无法访问的，为此可以选择自行部署一个 Vercel Function 并使用自己的域名进行访问，开发者也给出了示例代码，你可以在 [apps/vite-app/api/tweet/](https://github.com/vercel/react-tweet/blob/main/apps/vite-app/api/tweet/%5Btweet%5D.ts) 找到。
